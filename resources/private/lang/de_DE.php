...
$translations = [
    ...
    'labels.transp' => 'Diese Zeit anzeigen als',
    ...
    'labels.unsubscribe' => 'Abbestellen',
    ...
    'labels.subscribed_calendars' => 'Abonnements',
    ...
    'labels.create_calendar' => 'Neuen Kalender anlegen',
    'labels.subscribe' => 'Abonnieren',
    'labels.subscribe_ical' => 'iCal-Feed abonnieren',
    'labels.login' => 'Anmelden',
    'labels.logout' => 'Abmelden',
    'labels.duplicate' => 'Duplizieren',
    ...
    'labels.edit_only_this_repetition' => 'Nur diesen Termin ändern',
    'labels.edit_all_repetitions' => 'Alle Wiederholungen ändern',
    ...
    'labels.every' => 'Alle',
    'labels.repeat_by_day' => 'Wiederholen am',
    'labels.repeat_by_month_day' => 'Tag des Monats',
    'labels.repeat_explanation' => 'Dieser Termin wiederholt sich am',
    'labels.keep_rrule' => 'Vorhandene Wiederholungsregel beibehalten',
...
// Messages
    ...
    'messages.info_shareexplanation' => 'Sie können diesen Kalender mit anderen Nutzern teilen und bearbeiten lassen. Geben Sie unten die Benutzernamen ein, getrennt durch Kommas oder Leerzeichen',
    ...
    'messages.info_rrule_not_reproducible' => 'Dieser Termin hat Wiederholungsregeln hinterlegt, die mit diesem Programm nicht reproduzierbar sind. Sie können diese unverändert übernehmen.',
    'messages.info_rrule_protected' => 'Dieser Termin hat seine Wiederholungsregeln hinterlegt geschützt.',
    'messages.error_calendarnotfound' => 'Ungültiger Kalender %calendar',
    'messages.error_element_not_found' => 'Element konnte nicht gefunden werden.',
    'messages.error_element_changed' => 'Element wurde verändert, während Sie es editiert haben. Bitte laden Sie neu.',
    'messages.error_unexpectedhttpcode' => 'Unerwarteter HTTP Antwort-Code (%code) vom Server',
    ...
    'messages.internal_server_error' => 'Interner Server-Fehler.',
    ...
    'rrule.time' => 'Zeit',
    'rrule.times' => 'Zeiten',
    'rrule.weekday' => 'Wochentag',
    'rrule.weekdays' => 'Wochentage',
    'rrule.in' => 'in',
    'rrule.on the' => 'am',
    'rrule.and' => 'und',
    'rrule.or' => 'oder',
